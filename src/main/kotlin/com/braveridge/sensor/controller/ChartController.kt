...
import com.braveridge.sensor.session.ChartSession
...
class ChartController(private val luxService: LuxService,
    ...
    fun lux(@RequestParam("device_id") deviceId: String?, model: Model): String {
        val deviceList = getDeviceListBySensorType(properties.authkeyId, properties.authkeySecret, SensorType.Lux)
    ...
    fun temperature(@RequestParam("device_id") deviceId: String?, model: Model): String {
        val deviceList = getDeviceListBySensorType(properties.authkeyId, properties.authkeySecret, SensorType.Temperature)
        model.addAttribute("deviceList", deviceList)
    ...
    fun moveDetection(@RequestParam("device_id") deviceId: String?, model: Model): String {
        val deviceList = getDeviceListBySensorType(properties.authkeyId, properties.authkeySecret, SensorType.MoveDetection)
        model.addAttribute("deviceList", deviceList)
    ...
    fun humidity(
        ...
        val deviceList = getDeviceListBySensorType(properties.authkeyId, properties.authkeySecret, SensorType.Humidity)
        model.addAttribute("deviceList", deviceList)
    ...
    data class DataResponse(val date: LocalDateTime,
                            val data: Double,
                            val deviceRssi: Int)

    data class SimpleDevice(val id: String,
                            val name: String,
                            val sensorId: String = "",
    ...
    fun getDeviceListBySensorType(authkeyId: String, authkeySecret: String, sensorType: SensorType)
            = bvgService.getDeviceList(authkeyId, authkeySecret)
