...
import com.braveridge.sensor.repository.SensorLogRepository
import org.springframework.stereotype.Service
import org.springframework.transaction.annotation.Transactional

@Service
@Transactional
class SensorLogService(private val repository: SensorLogRepository,
                       private val properties: BravegateProperties) {

    fun findAll(pager: Pager, appId: String? = null, routerId: String? = null, deviceId: String? = null, sensorId: String? = null)
            = repository.findAll(pager.countPerPage, (pager.currentPage - 1) * pager.countPerPage,
    ...
    fun totalCount(appId: String? = null, routerId: String? = null, deviceId: String? = null, sensorId: String? = null)
    ...
    fun convertToEntity(form: WebhookForm, jsonString: String) = SensorLogEntity(0, form.application.applicationId, form.application.name,
