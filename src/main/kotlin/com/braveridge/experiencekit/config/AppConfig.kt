package com.braveridge.experiencekit.config

import com.braveridge.experiencekit.client.BravegateClient
...
class AppConfig {
    ...
    // HTTPクライアントのインスタンス生成
    @Bean
    fun bravegateRetrofit(
        jacksonConverterFactory: JacksonConverterFactory,
        bravegateProperties: BravegateProperties
