...
interface BravegateClient {
    ...
    @GET("v1/groups")
    fun getGroupList(
        @Header("X-Braveridge-API-Key") apiKey: String,
    ...
    fun getRouterList(
        ...
        @Query("page") page: Int,
        @Query("limit") limit: Int
    ): Call<RouterListResponse>

    @POST("v1/routers")
    fun createRouter(
        @Header("X-Braveridge-API-Key") apiKey: String,
        @Header("X-Braveridge-Token") token: String,
        @Body routerRequest: RouterCreateRequest
    ): Call<RouterResponse>
    ...
    fun updateRouter(
        ...
        @Header("X-Braveridge-Token") token: String,
        @Path("id") routerId: String,
        @Body routerRequest: RouterUpdateRequest
    ): Call<RouterResponse>
    ...
    fun getRouterDataUsage(
        @Header("X-Braveridge-API-Key") apiKey: String,
        @Header("X-Braveridge-Token") token: String,
        @Path("id") routerId: String,
        @Query("start") start: String,
        @Query("end") end: String
    ): Call<RouterUsageResponse>
    ...
    fun createDevice(
        @Header("X-Braveridge-API-Key") apiKey: String,
        @Header("X-Braveridge-Token") token: String,
        @Body deviceRequest: DeviceCreateRequest
    ): Call<DeviceResponse>
    ...
    fun updateDevice(
        ...
        @Header("X-Braveridge-Token") token: String,
        @Path("id") deviceId: String,
        @Body deviceRequest: DeviceUpdateRequest
    ): Call<DeviceResponse>
    ...
    fun postApiKey(
        @Header("X-Braveridge-API-Key") apiKey: String,
        @Header("X-Braveridge-Token") token: String,
        @Body emptyRequest: Map<String, String> = mapOf()
    ): Call<ApiKeyResponse>
}