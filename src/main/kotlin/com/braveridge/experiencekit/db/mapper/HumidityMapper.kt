package com.braveridge.experiencekit.db.mapper
...
interface HumidityMapper {
    ...
    fun findAll(
        ...
        afterOrEqualDate: LocalDateTime? = null
    ): List<HumidityEntity>
    ...
    fun findSensorData(
        deviceId: String, sensorId: String,
    ...
    fun findSensorDataByRouter(
        routerId: String, sensorId: String,
        afterOrEqualDate: LocalDateTime, beforeOrEqualDate: LocalDateTime? = null,
        minRssi: Int? = null, perSeconds: Int = 60
    ): List<SensorDataEntity>
    ...
    @Select("SELECT * FROM humidity WHERE device_id = #{deviceId} ORDER BY id DESC LIMIT 1")
    fun lastSensorEntityByDeviceId(deviceId: String): HumidityEntity?
    ...
    @Delete("DELETE FROM humidity WHERE date < #{beforeDate} LIMIT #{limit}")
