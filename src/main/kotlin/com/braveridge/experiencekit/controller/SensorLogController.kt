...
import com.braveridge.experiencekit.service.SensorLogService
...
class SensorLogController(
    ...
    fun list(
        ...
        val appList = bvgService.getApplicationList()
        val routerList = bvgService.getRouterList()
        val deviceList = bvgService.getDeviceList()
